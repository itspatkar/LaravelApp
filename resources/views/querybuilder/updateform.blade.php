        ...
        <div class="container mx-5">
            <form method="post" action="{{ route('update', $student->id) }}">
                ...
                <div class="input-group mb-3">
                    ...
                    <td><input class="form-control" type="text" name="name" value="{{ $student->name }}" autofocus
                            required></td>
                </div>
                <div class="input-group mb-3">
                    <td><label class="input-group-text" for="email"><b>Email</b> </label></td>
                    <td><input class="form-control" type="email" name="email" value="{{ $student->email }}"
                            required>
                    </td>
                </div>
                <div class="input-group mb-3">
                    <td><label class="input-group-text" for="age"><b>Age</b> </label></td>
                    <td><input class="form-control" type="number" name="age" value="{{ $student->age }}" required>
                    </td>
                </div>
                <div class="input-group mb-3">
                    <td><label class="input-group-text" for="city"><b>City</b> </label></td>
                    <td><input class="form-control" type="text" name="city" value="{{ $student->city }}" required>
                    </td>
                </div>
